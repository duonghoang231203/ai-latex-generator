...
This project is indexed by GitNexus as **ai-latex-generator** (1240 symbols, 2042 relationships, 62 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ai-latex-generator/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ai-latex-generator/clusters` | All functional areas |
| `gitnexus://repo/ai-latex-generator/processes` | All execution flows |
| `gitnexus://repo/ai-latex-generator/process/{name}` | Step-by-step execution trace |
